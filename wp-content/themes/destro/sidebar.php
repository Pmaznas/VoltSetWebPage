                        ...
                        <div id="sidebar_section">
                            ...
                            <div id="sidebar_ads_container">                 
									...
									<div id="sidebarads">
										<?php if ( function_exists('dynamic_sidebar') && dynamic_sidebar('sidebar-ads-onetwofive') ){
																			} ?>   
		                            </div>  
                                    <?php endif; ?>
                            ...
                            <div id="feed_social">
                                            ...
                                            <div id="sidebar_twitter">
                                            	...
                                            	<p><a href="http://www.twitter.com/<?php echo of_get_option('twitter_id'); ?>"><?php _e('Follow On Twitter',  'Destro') ?></a></p>                                            
